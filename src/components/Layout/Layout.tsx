...
export default function Layout({children}: {children :React.ReactNode}) {
    ...
    const [error, setError] = useState<ErrorInterface>({status: false, message: ""});
    ...
    return(<>
    <PageContext.Provider  value={{error: error ,setError: setError, loading:loading,  setLoading: setLoading}}>
